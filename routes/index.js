...
router.post('/msg', wechat(wxConfig, function (req, res, next) {
    ...
    if (message.MsgType == 'event') {
        ...
        if (strArry.length > 1) {
            if (strArry[0] == '歌') {
                let baseUrl='https://i.y.qq.com/v8/playsong.html?hostuin=79277490&sharefrom=&from_id=0&from_idtype=0&from_name=&songid=102431886&songmid=&type=0&platform=(10rpl)&appsongtype=(11rpl)&_wv=1&source=qq&appshare=iphone&media_mid=000dFaKW2vjFOp&from=singlemessage&isappinstalled=0';
                                    ...
                                    if(data.data[0].file) {
                                        ...
                                        res.reply({
                                            ...
                                            content: {
                                                ...
                                                musicUrl:'https://i.y.qq.com/v8/playsong.html?hostuin=79277490&sharefrom=&from_id=0&from_idtype=0&from_name=&songid=102431886&songmid=&type=0&platform=(10rpl)&appsongtype=(11rpl)&_wv=1&source=qq&appshare=iphone&media_mid=000dFaKW2vjFOp&from=singlemessage&isappinstalled=0',
                                                hqMusicUrl: 'https://i.y.qq.com/v8/playsong.html?hostuin=79277490&sharefrom=&from_id=0&from_idtype=0&from_name=&songid=102431886&songmid=&type=0&platform=(10rpl)&appsongtype=(11rpl)&_wv=1&source=qq&appshare=iphone&media_mid=000dFaKW2vjFOp&from=singlemessage&isappinstalled=0',
